...
const dest = resolve(HERE, "../../aperion/templates/simple/icons.html");

/** @type import("./tools/jinja_svg_catalog.js").JinjaMacro[] */
const aperion_jinja_macros = [
...
const simple_icons = [
  ...
  // - https://github.com/aperion/aperion/pull/4284#issuecomment-2680550342
  {
...
jinja_svg_sets(dest, aperion_jinja_macros, simple_icons);
