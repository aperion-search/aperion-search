...
aperion.ready(() => {
  aperion.infinite_scroll_supported =
  ...
  if (!aperion.infinite_scroll_supported) {
  ...
  function loadNextPage(callback) {
    ...
    aperion
      ...
      .catch((err) => {
        ...
        e.textContent = aperion.settings.translations.error_loading_next_page;
  ...
  if (aperion.settings.infinite_scroll && aperion.infinite_scroll_supported) {
