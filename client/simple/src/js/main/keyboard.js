...
aperion.ready(() => {
  ...
  aperion.on(".result", "click", function (e) {
  ...
  const keyBindings = keyBindingLayouts[aperion.settings.hotkeys] || keyBindingLayouts.default;

  aperion.on(document, "keydown", (e) => {
  ...
  function initHelpContent(divElement) {
    ...
    html += "<h3>How to navigate aperion with hotkeys</h3>";
    html += "<table>";
  ...
  aperion.scrollPageToSelected = scrollPageToSelected;
  aperion.selectNext = highlightResult("down");
  aperion.selectPrevious = highlightResult("up");
});
