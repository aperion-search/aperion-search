...
((_w, _d, aperion) => {
  aperion.ready(() => {
    aperion.on(".aperion_init_map", "click", function (event) {
      // no more request
      this.classList.remove("aperion_init_map");
      ...
      aperion.loadStyle("css/leaflet.css");
      aperion.loadScript("js/leaflet.js", () => {
        let map_bounds = null;
        if (map_boundingbox) {
