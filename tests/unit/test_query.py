...
class TestQuery(AperionTestCase):
...
class TestLanguageParser(AperionTestCase):
...
class TestTimeoutParser(AperionTestCase):
...
class TestExternalBangParser(AperionTestCase):
...
class TestBang(AperionTestCase):
