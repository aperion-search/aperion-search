...
from aperion.network.network import Network, NETWORKS
from tests import AperionTestCase


class TestNetwork(AperionTestCase):
...
class TestNetworkRequestRetries(AperionTestCase):
...
class TestNetworkStreamRetries(AperionTestCase):
