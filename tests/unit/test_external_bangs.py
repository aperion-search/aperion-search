...
from aperion.external_bang import (
    get_node,
...
class TestGetNode(AperionTestCase):
...
class TestResolveBangDefinition(AperionTestCase):
...
class TestGetBangDefinitionAndAutocomplete(AperionTestCase):
...
class TestExternalBangJson(AperionTestCase):
