...
class TestUtils(AperionTestCase):
    ...
    def test_aperion_useragent(self):
        self.assertIsInstance(utils.aperion_useragent(), str)
        self.assertIsNotNone(utils.aperion_useragent())
        self.assertTrue(utils.aperion_useragent().startswith('aperion'))
...
class TestHTMLTextExtractor(AperionTestCase):  # pylint: disable=missing-class-docstring
...
class TestXPathUtils(AperionTestCase):  # pylint: disable=missing-class-docstring
    ...
    def test_get_xpath_invalid(self):
        ...
        with self.assertRaises(AperionXPathSyntaxException) as context:
    ...
    def test_eval_xpath_unregistered_function(self):
        ...
        with self.assertRaises(AperionEngineXPathException) as context:
