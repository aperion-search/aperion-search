...
from aperion.locales import locales_initialize
...
class TestSettings(AperionTestCase):
    ...
    def test_plugins_setting_all_default_enabled(self):
        storage = aperion.plugins.PluginStorage()
...
class TestPreferences(AperionTestCase):
