...
"""Test some code from module :py:obj:`aperion.locales`"""
...
class TestLocales(AperionTestCase):
    """Implemented tests:

    - :py:obj:`aperion.locales.match_locale`
    """
