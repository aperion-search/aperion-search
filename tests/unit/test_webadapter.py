...
from aperion.search import EngineRef
from aperion.webadapter import validate_engineref_list
...
class ValidateQueryCase(AperionTestCase):

    def test_without_token(self):
        preferences = Preferences(['simple'], ['general'], engines, aperion.plugins.STORAGE)
    ...
    def test_with_incorrect_token(self):
        preferences_with_tokens = Preferences(['simple'], ['general'], engines, aperion.plugins.STORAGE)
