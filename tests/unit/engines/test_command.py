...
from aperion.engines import command as command_engine
from aperion.result_types import KeyValue

from tests import AperionTestCase


class TestCommandEngine(AperionTestCase):
    ...
    def test_delimiter_parsing(self):
        aperion_logs = '''DEBUG:aperion.webapp:static directory is /home/n/p/aperion/aperion/static
DEBUG:aperion.webapp:templates directory is /home/n/p/aperion/aperion/templates
DEBUG:aperion.engines:soundcloud engine: Starting background initialization
DEBUG:aperion.engines:wolframalpha engine: Starting background initialization
DEBUG:aperion.engines:locate engine: Starting background initialization
DEBUG:aperion.engines:regex search in files engine: Starting background initialization
...
DEBUG:aperion.engines:find engine: Starting background initialization
DEBUG:aperion.engines:pattern search in files engine: Starting background initialization
DEBUG:aperion.webapp:starting webserver on 127.0.0.1:8888
WARNING:werkzeug: * Debugger is active!
INFO:werkzeug: * Debugger PIN: 299-578-362'''
        echo_engine = command_engine
        echo_engine.command = ['echo', aperion_logs]
        echo_engine.delimiter = {'chars': ':', 'keys': ['level', 'component', 'message']}

        page1 = [
            {
                'component': 'aperion.webapp',
                'message': 'static directory is /home/n/p/aperion/aperion/static',
                'level': 'DEBUG',
            },
            {
                'component': 'aperion.webapp',
                'message': 'templates directory is /home/n/p/aperion/aperion/templates',
                'level': 'DEBUG',
            },
            {
                'component': 'aperion.engines',
