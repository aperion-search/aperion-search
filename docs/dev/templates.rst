...
:origin:`sources <aperion/templates/simple/>`.
...
<aperion/templates/simple/macros.html>`:
...
<aperion/templates/simple/results.html>` in a HTML ``<form/>`` element.  The
intention of this macro is to pass data of a engine from one :py:obj:`response
<aperion.engines.demo_online.response>` to the :py:obj:`aperion.search.SearchQuery`
of the next :py:obj:`request <aperion.engines.demo_online.request>`.
...
the :origin:`result_templates <aperion/templates/simple/result_templates>`.
...
<aperion/templates/simple/result_templates/default.html>`:
...
<aperion/templates/simple/result_templates/images.html>`:
...
filesize: :py:class:`str`
  Size of bytes in :py:obj:`human readable <aperion.humanize_bytes>` notation
...
<aperion/templates/simple/result_templates/videos.html>`:
...
<aperion/templates/simple/result_templates/torrent.html>`:
...
<aperion/templates/simple/result_templates/map.html>`:
...
<aperion/templates/simple/result_templates/paper.html>`:
...
<aperion/templates/simple/result_templates/packages.html>`:
...
<aperion/templates/simple/result_templates/code.html>`:
...
Additional fields used in the :origin:`code.html
<aperion/templates/simple/result_templates/files.html>`:
...
<aperion/templates/simple/result_templates/products.html>`:
