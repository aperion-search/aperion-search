...
.. _translate.codeberg.org: https://translate.codeberg.org/projects/Aperion-Search/
.. _Weblate: https://docs.weblate.org
.. _translations branch: https://github.com/burhanuddin-1/s/tree/translations
.. _orphan branch: https://git-scm.com/docs/git-checkout#Documentation/git-checkout.txt---orphanltnewbranchgt
.. _Weblate repository: https://translate.codeberg.org/projects/Aperion-Search/Aperion-Search/#repository
.. _wlc: https://docs.weblate.org/en/latest/wlc.html

.. |translated| image:: https://translate.codeberg.org/widgets/Aperion-Search/-/Aperion-Search/svg-badge.svg
   :target: https://translate.codeberg.org/projects/Aperion-Search/

.. sidebar:: |translated|

   - :ref:`aperion.babel_extract`
   - Weblate_
   - Aperion Search `translations branch`_
   - Aperion Search `Weblate repository`_
   - Weblate Client: wlc_
...
committed to Weblate's counterpart of the Aperion Search *origin* repository which is
located at ``https://translate.codeberg.org/git/Aperion-Search/Aperion-Search``.

There is no need to clone this repository, :ref:`Aperion Search Weblate workflow` take
care of the synchronization with the *origin*.  To avoid merging commits from
the counterpart directly on the ``master`` branch of *Aperion Search origin*, a *pull
...
.. _Aperion Search Weblate workflow:

.. figure:: translation.svg

   Aperion Search's PR workflow to be in sync with Weblate

Sync from *origin* to *weblate*: using ``make weblate.push.translations``
  For each commit on the ``master`` branch of Aperion Search *origin* the GitHub job
