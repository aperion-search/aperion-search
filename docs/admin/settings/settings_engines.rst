...
``timeout`` : optional
  ...
  modify the global timeout of aperion.**
...
aperion does not support true multilingual search.  You have to use the language
...
language, aperion will search in your default and other language.
