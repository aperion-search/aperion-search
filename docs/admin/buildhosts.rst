...
build hosts (see :ref:`aperion.sh`).

.. _aperion.sh install buildhost:
...
.. tabs::
  ...
  .. group-tab:: aperion's development tools

     .. code:: sh

        $ sudo -H ./utils/aperion.sh install buildhost

This will install packages needed by aperion:
...
output (:ref:`install buildhost <aperion.sh install buildhost>`).
...
(:ref:`install buildhost <aperion.sh install buildhost>`).
