...
This section explains how to set up a aperion instance using the HTTP server nginx_.
If you have used the :ref:`installation scripts` and do not have any special preferences
you can install the :ref:`aperion site <nginx aperion site>` using
:ref:`aperion.sh <aperion.sh overview>`:

.. code:: bash

   $ sudo -H ./utils/aperion.sh install nginx
...
NGINX's aperion site
====================

Now you have to create a configuration file (``aperion.conf``) for the aperion
...
Depending on what your aperion installation is listening on, you need a http or socket
...
.. tabs::
   ...
   .. group-tab:: Ubuntu / debian
      ...
      .. code:: bash
         ...
         sudo -H ln -s /etc/nginx/sites-available/aperion.conf \
                       /etc/nginx/sites-enabled/aperion.conf
   ...
   .. group-tab:: Arch Linux
      ...
      .. code:: bash
         ...
         sudo -H ln -s /etc/nginx/default.apps-available/aperion.conf \
                       /etc/nginx/default.d/aperion.conf
...
.. tabs::
   ...
   .. group-tab:: Ubuntu / debian
      ...
      .. code:: bash
         ...
         sudo -H service uwsgi restart aperion
   ...
   .. group-tab:: Arch Linux
      ...
      .. code:: bash
         ...
         sudo -H systemctl restart nginx
         sudo -H systemctl restart uwsgi@aperion
   ...
   .. group-tab:: Fedora / RHEL
      ...
      .. code:: bash
         ...
         sudo -H systemctl restart nginx
         sudo -H touch /etc/uwsgi.d/aperion.ini
