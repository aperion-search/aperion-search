...
With the *SQL engines* you can bind SQL databases into aperion.  The following
...
<aperion/settings.yml>`, as you have to set the required attributes for the
...
see :origin:`simple <aperion/templates/simple/result_templates/key-value.html>`
theme.  If you are not satisfied with the original result layout, you can use
your own template, set ``result_template`` attribute to ``{template_name}`` and
place the templates at::

  aperion/templates/{theme_name}/result_templates/{template_name}
...
install additional packages in Python's Virtual Environment of your aperion
instance.  To switch into the environment (:ref:`aperion-src`) you can use
:ref:`aperion.sh`::

  $ sudo utils/aperion.sh instance cmd bash
  (aperion-pyenv)$ pip install ...
...
.. sidebar:: info
   ...
   - :origin:`sqlite.py <aperion/engines/sqlite.py>`

.. automodule:: aperion.engines.sqlite
  :members:
...
.. sidebar:: info
   ...
   - :origin:`postgresql.py <aperion/engines/postgresql.py>`
   - ``pip install`` `psycopg2-binary <psycopg2>`_

.. automodule:: aperion.engines.postgresql
  :members:
...
.. sidebar:: info
   ...
   - :origin:`mysql_server.py <aperion/engines/mysql_server.py>`
   - ``pip install`` :pypi:`mysql-connector-python <mysql-connector-python>`


.. automodule:: aperion.engines.mysql_server
  :members:
...
.. sidebar:: info
   ...
   - :origin:`mariadb_server.py <aperion/engines/mariadb_server.py>`
   - ``pip install`` :pypi:`mariadb <mariadb>`


.. automodule:: aperion.engines.mariadb_server
  :members:
