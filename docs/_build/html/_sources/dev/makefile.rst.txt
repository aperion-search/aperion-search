...
*developer install* of aperion (:origin:`setup.py`). ::

   $ cd ~/aperion-clone
   $ make install
   PYENV     [virtualenv] installing ./requirements*.txt into local/py3
   ...
   PYENV     [install] pip install --use-pep517 --no-build-isolation -e 'aperion[test]'
   ...
   Successfully installed aperion-2023.7.19+a446dea1b
...
.. tabs::
  ...
  .. group-tab:: nvm.install
     ...
     .. code:: sh
        ...
        INFO:  install (update) NVM at ./aperion/.nvm
        INFO:  clone: https://github.com/nvm-sh/nvm.git
          || Cloning into './aperion/.nvm'...
...
Install latest Node.js_ LTS locally (uses nvm_)::
  ...
  $ make nvm.nodejs
  INFO:  install (update) NVM at /share/aperion/.nvm
  INFO:  clone: https://github.com/nvm-sh/nvm.git
  ...
  Downloading and installing node v16.13.0...
  ...
  INFO:  Node.js is installed at aperion/.nvm/versions/node/v16.13.0/bin/node
  INFO:  Node.js is version v16.13.0
  INFO:  npm is installed at aperion/.nvm/versions/node/v16.13.0/bin/npm
  INFO:  npm is version 8.1.0
  INFO:  NVM is installed at aperion/.nvm
...
*debug* option in :origin:`aperion/settings.yml`, starts a ``./aperion/webapp.py``
...
Python programming language.  The pylint profile used in the aperion project is
...
To see HTTP requests and more use aperion_DEBUG::

    make aperion_DEBUG=1 search.checker.google_news

.. _3xx: https://en.wikipedia.org/wiki/List_of_HTTP_status_codes#3xx_redirection

To filter out HTTP redirects (3xx_)::

    make aperion_DEBUG=1 search.checker.google_news | grep -A1 "HTTP/1.1\" 3[0-9][0-9]"
    ...
