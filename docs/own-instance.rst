...
.. sidebar:: Is running my own instance worth it?
  ...
  \.\.\.is a common question among Aperion Search users.  Before answering this
  question, see what options an Aperion Search user has.
...
instances can be used by a select group of people, such as an Aperion Search instance for a
...
To gain more insight on how these instances work, let's dive into how Aperion Search
protects its users.

.. _Aperion Search protect privacy:

How does Aperion Search protect privacy?
========================================

Aperion Search protects the privacy of its users in multiple ways, regardless of the type
...
both cases.  The IP address used will be the IP of the instance, but Aperion Search can also be
configured to use proxy or Tor.

Aperion Search does not serve ads or tracking content, unlike most search services.  Therefore,
...
need to use cookies to tailor Aperion Search to their needs and preferences will not
...
features of Aperion Search are available to users no matter what kind of instance they
use.

For those on the go, or just wanting to try Aperion Search for the first time, public
