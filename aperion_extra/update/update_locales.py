...
"""Update locale names in :origin:`aperion/data/locales.json` used by
:ref:`aperion.locales`

- :py:obj:`aperion.locales.RTL_LOCALES`
- :py:obj:`aperion.locales.LOCALE_NAMES`
"""
...
LOCALE_DATA_FILE = Path(Aperion_dir) / 'data' / 'locales.json'
TRANSLATIONS_FOLDER = Path(Aperion_dir) / 'translations'
