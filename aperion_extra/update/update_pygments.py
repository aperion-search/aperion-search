...
LESS_FILE = Path(Aperion_dir).parent / 'client/simple/generated/pygments.less'

HEADER = f"""\
/*
   this file is generated automatically by aperion_extra/update/update_pygments.py
