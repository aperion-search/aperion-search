...
"""Fetch currencies from :origin:`aperion/engines/wikidata.py` engine.

Output file: :origin:`aperion/data/currencies.json` (:origin:`CI Update data ...
...
from aperion.locales import LOCALE_NAMES, locales_initialize
from aperion.engines import wikidata, set_loggers
from aperion.data.currencies import CurrenciesDB
...
def main():
    ...
    # aperion.search.processors.online_currency.name_to_iso4217
