...
help:
	...
	@echo 'install        - developer install of aperion into virtualenv'
...
search.checker: install
	$(Q)./manage pyenv.cmd aperion-checker -v

search.checker.%: install
	$(Q)./manage pyenv.cmd aperion-checker -v "$(subst _, ,$(patsubst search.checker.%,%,$@))"
