...
:py:obj:`aperion.cache.ExpireCacheSQLite` :
  ...
  example, for the engines, see :py:obj:`aperion.enginelib.EngineCache`.

:py:obj:`aperion.favicons.cache.FaviconCacheSQLite` :
