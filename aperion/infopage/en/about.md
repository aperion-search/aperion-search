...
- Aperion Search may not offer you as personalized results as Google, but it doesn't
  generate a profile about you.
- Aperion Search doesn't care about what you search for, never shares anything with a
  third-party, and can't be used to compromise you.

If you do care about privacy, want to be a conscious user, or otherwise believe
in digital freedom, make Aperion Search your default search engine or run it on your
own browser!

## How do I set it as the default search engine?

Aperion Search supports [OpenSearch].  For more information on changing your default
...
- Remove the duplicate (default name: Aperion Search) or
