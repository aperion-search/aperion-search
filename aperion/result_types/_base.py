...
class Result(msgspec.Struct, kw_only=True):
    ...
    <aperion/templates/simple/result_templates/default.html>` is used.
    """
...
class LegacyResult(dict):
    """A wrapper around a legacy result item.  The aperion core uses this class
    ...
    :py:obj:`aperion.results.ResultContainer`.
    ...
    def __init__(self, *args, **kwargs):
        ...
        if "answer" in self:
            warnings.warn(
                ...
                f" / use a class from aperion.result_types.answer",
                DeprecationWarning,
            )
        ...
        if self.template == "keyvalue.html":
            warnings.warn(
                ...
                f" / use a class from aperion.result_types",
                DeprecationWarning,
            )
