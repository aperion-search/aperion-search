...
the :origin:`answers.html <aperion/templates/simple/elements/answers.html>`
template.
...
class Translations(BaseAnswer, kw_only=True):
    ...
    <aperion/templates/simple/answer/translations.html>`"""
...
class WeatherAnswer(BaseAnswer, kw_only=True):
    ...
    <aperion/templates/simple/answer/weather.html>`"""
