...
and unpack into ``aperion/data/filmliste-v2.db``.  To search the database use e.g
...
.. code:: yaml
  ...
  - name: mediathekview
    ...
    database: aperion/data/filmliste-v2.db
    query_str: >-
...
from aperion.result_types import MainResult, KeyValue
