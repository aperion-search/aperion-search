...
authentication.  What this means is that by default, aperion will have no way to
...
"""Optional, if true aperion will link directly to the mp4 of the video to play
