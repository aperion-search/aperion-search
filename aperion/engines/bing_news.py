...
"""Bing-News: description see :py:obj:`aperion.engines.bing`.
...
from aperion.engines.bing import set_bing_cookies
...
def fetch_traits(engine_traits: EngineTraits):
    ...
    from aperion.engines.bing import fetch_traits as _f
