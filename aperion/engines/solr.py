...
""".. sidebar:: info
   ...
   - :origin:`solr.py <aperion/engines/solr.py>`
...
def response(resp: SXNG_Response) -> EngineResults:
    try:
        ...
        raise AperionEngineAPIException("failed to parse response") from e

    if "error" in resp_json:
        raise AperionEngineAPIException(resp_json["error"]["msg"])
