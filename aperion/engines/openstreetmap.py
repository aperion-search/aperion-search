...
from aperion.data import OSM_KEYS_TAGS, CURRENCIES
from aperion.external_urls import get_external_url
from aperion.engines.wikidata import send_wikidata_query, sparql_string_escape, get_thumbnail
