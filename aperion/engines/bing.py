...
in aperion to get the translations of data such as *"published last week"*.
...
from aperion.utils import eval_xpath, extract_text, eval_xpath_list, eval_xpath_getindex
from aperion.locales import language_tag, region_tag
from aperion.enginelib.traits import EngineTraits
from aperion.exceptions import AperionEngineAPIException
...
verification by a cookie is needed / thats not possible in aperion.
"""
...
def request(query, params):
    ...
    engine_region = traits.get_region(params['aperion_locale'], traits.all_locale)  # type: ignore
    engine_language = traits.get_language(params['aperion_locale'], 'en')  # type: ignore
...
def response(resp):
    ...
    if results:
        ...
        if expected_start != start:
            ...
            raise AperionEngineAPIException(msg)
