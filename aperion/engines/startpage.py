...
from aperion.utils import extr, extract_text, eval_xpath, gen_useragent, html_to_text, humanize_bytes, remove_pua_from_str
...
from aperion.locales import region_tag
...
def get_sc_code(aperion_locale, params):
    ...
    if aperion_locale == 'all':
        aperion_locale = 'en-US'
    ...
    try:
        ...
        logger.debug("suspend startpage API --> https://github.com/aperion/aperion/pull/695")
        raise AperionEngineCaptchaException(
...
def request(query, params):
    ...
    """
    engine_region = traits.get_region(params['aperion_locale'], 'en-US')
    engine_language = traits.get_language(params['aperion_locale'], 'en')
    ...
    args = {
        ...
        'cat': startpage_categ,
        't': 'device',
        'sc': get_sc_code(params['aperion_locale'], params),  # hint: this func needs HTTP headers
...
def fetch_traits(engine_traits: EngineTraits):
    ...
    skip_eng_tags = {
        'english_uk',  # aperion lang 'en' already maps to 'english'
    }
