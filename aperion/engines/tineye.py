...
.. hint::
   ...
   This aperion engine only supports *'searching by URL'* and it does not use
...
""":py:obj:`aperion.search.processors.online_url_search`"""
    ...
    if resp.status_code in (400, 422):
        ...
        if resp.status_code == 422:
            ...
            if s_key == "Invalid image URL":
                # test https://docs.aperion.org/_static/aperion-wordmark.svg
        ...
        # see https://github.com/aperion/aperion/pull/1456#issuecomment-1193105023
