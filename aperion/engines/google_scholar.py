...
from aperion.engines.google import fetch_traits  # pylint: disable=unused-import
from aperion.engines.google import (
    get_google_info,
    time_range_dict,
)
...
def time_range_args(params):
    ...
    month* or *last week* (as offered by aperion) is uncommon for scientific
    publications and is not supported by Google Scholar.

    To limit the result list when the users selects a range, all the aperion
