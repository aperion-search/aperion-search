...
from aperion.engines import categories as Aperion_categories

# about
about = {
    "website": 'https://github.com/aperion/aperion',
    "wikidata_id": 'Q17639196',
    "official_api_documentation": 'https://docs.aperion.org/dev/search_api.html',
    "use_official_api": True,
    "require_api_key": False,
    "results": 'JSON',
}

categories = Aperion_categories.keys()
