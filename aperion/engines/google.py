...
from aperion.utils import extract_text, eval_xpath, eval_xpath_list, eval_xpath_getindex
from aperion.locales import language_tag, region_tag, get_official_locales
...
.. _Google max 50 pages: https://github.com/aperion/aperion/issues/2982
"""
...
def get_google_info(params, eng_traits):
    ...
    :param dict param: Request parameters of the engine.  At least
        a ``aperion_locale`` key should be in the dictionary.

    :param eng_traits: Engine's traits fetched from google preferences
        (:py:obj:`aperion.enginelib.traits.EngineTraits`)
    ...
    sxng_locale = params.get('aperion_locale', 'all')
    try:
    ...
    # https://github.com/aperion/aperion/issues/2515#issuecomment-1607150817
    ...
    # locale --> https://github.com/aperion/aperion/issues/2672
    ret_val['params']['cr'] = ''
    ...
    # https://github.com/aperion/aperion/issues/2515#issuecomment-1606294635
    ...
    # - https://github.com/aperion/aperion/pull/1679#issuecomment-1235432746
    # - https://github.com/aperion/aperion/issues/1555
...
def detect_google_sorry(resp):
    if resp.url.host == 'sorry.google.com' or resp.url.path.startswith('/sorry'):
        raise AperionEngineCaptchaException()
