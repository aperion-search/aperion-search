...
from aperion import logger, settings
...
def check_engine_module(module: types.ModuleType):
    ...
    # network: https://github.com/aperion/aperion/issues/762#issuecomment-1605323861
...
def load_engine(engine_data: dict) -> Engine | types.ModuleType | None:
    ...
    from aperion.enginelib.traits import EngineTraitsMap
...
def set_loggers(engine, engine_name):
    ...
    for module_name, module in modules.items():
        if (
            module_name.startswith("aperion.engines")
            and module_name != "aperion.engines.__init__"
