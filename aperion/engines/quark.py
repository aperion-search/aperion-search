...
"""Quark (Shenma) search engine for aperion"""
...
from aperion.exceptions import AperionEngineAPIException, AperionEngineCaptchaException
...
def init(_):
    if quark_category not in ('general', 'images'):
        raise AperionEngineAPIException(f"Unsupported category: {quark_category}")
