...
from aperion.data import WIKIDATA_UNITS
from aperion.network import post, get
from aperion.utils import aperion_useragent, get_string_replaces_function
from aperion.external_urls import get_external_url, get_earth_coordinates_url, area_to_osm_zoom
from aperion.engines.wikipedia import (
...
def get_headers():
    ...
    return {'Accept': 'application/sparql-results+json', 'User-Agent': aperion_useragent()}
...
def request(query, params):
    ...
    eng_tag, _wiki_netloc = get_wiki_params(params['aperion_locale'], traits)
...
def init(engine_settings=None):  # pylint: disable=unused-argument
    ...
    for result in jsonresponse.get('results', {}).get('bindings', {}):
        ...
        lang = result.get('name', {}).get('xml:lang', 'en')
...
def fetch_traits(engine_traits: EngineTraits):
    ...
    <aperion.engines.wikipedia.fetch_wikimedia_traits>` and removes
