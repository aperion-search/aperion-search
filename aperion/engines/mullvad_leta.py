...
from aperion.locales import get_official_locales, language_tag, region_tag
from aperion.utils import eval_xpath_list
from aperion.result_types import EngineResults, MainResult
...
def request(query: str, params: dict):
    ...
    country = traits.get_region(params.get("aperion_locale"), traits.all_locale)  # type: ignore
    if country:
        args["country"] = country

    language = traits.get_language(params.get("aperion_locale"), traits.all_locale)  # type: ignore
    if language:
...
def fetch_traits(engine_traits: EngineTraits) -> None:
    ...
    # see https://github.com/aperion/aperion/issues/762
    from aperion.network import get as http_get
