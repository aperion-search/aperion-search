...
""".. sidebar:: info
   ...
   - :origin:`elasticsearch.py <aperion/engines/elasticsearch.py>`
...
def _match_query(query):
    ...
    aperion format: "key:value" e.g. city:berlin
...
def _terms_query(query):
    ...
    aperion format: "key:value1,value2" e.g. city:berlin,paris
...
def response(resp: SXNG_Response) -> EngineResults:
    ...
    if 'error' in resp_json:
        raise AperionEngineAPIException(resp_json["error"])
