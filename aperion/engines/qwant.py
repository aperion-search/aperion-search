...
from aperion.network import raise_for_httperror
...
def request(query, params):
    ...
    q_locale = traits.get_region(params["aperion_locale"], default='en_US')
...
def parse_web_api(resp):
    ...
    if search_results.get('status') != 'success':
        ...
        raise AperionEngineAPIException(f"{msg} ({error_code})")
...
def fetch_traits(engine_traits: EngineTraits):
    ...
    from aperion import network
    from aperion.locales import region_tag
    from aperion.utils import extr
