...
"""aperion preferences implementation.
"""
...
from aperion import settings, autocomplete, favicons
...
from aperion.locales import LOCALE_NAMES
...
class PluginsSetting(BooleanChoices):
    ...
    def __init__(self, default_value, plugins: Iterable[aperion.plugins.Plugin]):
...
class ClientPref:
    ...
    # hint: aperion.webapp.get_client_settings should be moved into this class
...
class Preferences:
    ...
    def __init__(
        ...
        plugins: aperion.plugins.PluginStorage,
