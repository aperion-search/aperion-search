...
from aperion import logger, settings, sxng_debug
from aperion.valkeydb import client as get_valkey_client
from aperion.exceptions import AperionSettingsException
from aperion.search.processors import PROCESSORS
from aperion.search.checker import Checker
from aperion.search.checker.scheduler import scheduler_function


VALKEY_RESULT_KEY = 'aperion_checker_result'
VALKEY_LOCK_KEY = 'aperion_checker_lock'
...
def _get_interval(every: Any, error_msg: str) -> Tuple[int, int]:
    ...
    if (
        ...
        raise AperionSettingsException(error_msg, None)
