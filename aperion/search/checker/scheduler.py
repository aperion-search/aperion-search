...
* the Valkey key aperion_checker_next_call_ts contains the next time the embedded checker should run.
* to avoid lock, a unique Valkey script reads and updates the Valkey key aperion_checker_next_call_ts.
...
from aperion.valkeylib import lua_script_storage


logger = logging.getLogger('aperion.search.checker')
