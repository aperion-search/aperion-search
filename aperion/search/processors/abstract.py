...
from aperion import settings, logger
from aperion.engines import engines
from aperion.network import get_time_for_thread, get_network
from aperion.metrics import histogram_observe, counter_inc, count_exception, count_error
from aperion.exceptions import AperionEngineAccessDeniedException, AperionEngineResponseException
from aperion.utils import get_engine_from_settings

logger = logger.getChild('aperion.search.processor')
...
class EngineProcessor(ABC):
    ...
    def initialize(self):
        ...
        except AperionEngineResponseException as exc:
    ...
    def handle_exception(self, result_container, exception_or_message, suspend=False):
        ...
        if suspend:
            suspended_time = None
            if isinstance(exception_or_message, AperionEngineAccessDeniedException):
    ...
    def get_params(self, search_query, engine_category):
        ...
        params['aperion_locale'] = search_query.lang

        # deprecated / vintage --> use params['aperion_locale']
        #
