...
"""This module implements the type extensions applied by aperion.
...
if typing.TYPE_CHECKING:
    ...
    import aperion.results


class SXNG_Request(flask.Request):
    """aperion extends the class :py:obj:`flask.Request` with properties from
    *this* class definition, see type cast :py:obj:`sxng_request`.
    """

    user_plugins: list[str]
    """list of aperion.plugins.Plugin.id (the id of the plugins)"""

    preferences: "aperion.preferences.Preferences"
    """The preferences of the request."""

    errors: list[str]
    """A list of errors (translated text) added by :py:obj:`aperion.webapp` in
    case of errors."""
    ...
    :py:obj:`aperion.webapp` to calculate the total time of the request."""

    render_time: float
    """Duration of the rendering, calculated and added by
    :py:obj:`aperion.webapp`."""

    timings: list["aperion.results.Timing"]
    """A list of :py:obj:`aperion.results.Timing` of the engines, calculatid in
    and hold by :py:obj:`aperion.results.ResultContainer.timings`."""
...
class SXNG_Response(httpx.Response):
    """aperion extends the class :py:obj:`httpx.Response` with properties from
