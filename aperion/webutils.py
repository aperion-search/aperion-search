...
from aperion import logger, get_setting

from aperion.engines import DEFAULT_CATEGORY

if TYPE_CHECKING:
    from aperion.enginelib import Engine
    from aperion.results import ResultContainer
    from aperion.search import SearchQuery
    from aperion.results import UnresponsiveEngine
...
exception_classname_to_text = {
    ...
    'aperion.exceptions.AperionEngineCaptchaException': gettext("CAPTCHA"),
    'aperion.exceptions.AperionEngineTooManyRequestsException': gettext("too many requests"),
    'aperion.exceptions.AperionEngineAccessDeniedException': gettext("access denied"),
    'aperion.exceptions.AperionEngineAPIException': gettext("server API error"),
    'aperion.exceptions.AperionEngineXPathException': parsing_error_text,
...
def aperion_l10n_timespan(dt: datetime) -> str:  # pylint: disable=invalid-name
