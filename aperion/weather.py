...
from aperion.cache import ExpireCache, ExpireCacheCfg
from aperion.extended_types import sxng_request
from aperion.wikidata_units import convert_to_si, convert_from_si
...
def _get_sxng_locale_tag() -> str:
    ...
    #
    # In principle, aperion only has two possible parameters for determining
    ...
    # probably never be available in aperion (privacy critical).
    #
    ...
    from aperion import query
    from aperion.preferences import ClientPref
...
class WindSpeed:
    ...
    .. hint::
       ...
       Working with unit ``Bft`` (:py:obj:`aperion.wikidata_units.Beaufort`) will
