...
""".. sidebar:: Further reading ..
   ...
   - :ref:`plugins admin`
   - :ref:`aperion settings <settings plugins>`

Plugins can extend or replace functionality of various components of aperion.
...
built-in plugins :origin:`aperion/plugins/` or `Only show green hosted results`_.
...
.. code:: python
   ...
   from aperion.plugins import Plugin
...
.. sidebar:: Further reading ..
   ...
   - :py:obj:`Result.filter_urls(..) <aperion.result_types._base.Result.filter_urls>`

The :py:obj:`Result.filter_urls(..) <aperion.result_types._base.Result.filter_urls>`
...
def initialize(app):
    STORAGE.load_settings(aperion.get_setting("plugins"))
    STORAGE.init(app)
