...
the ``settings.yml`` file is already located (``/etc/aperion``). The file then
...
from aperion.result_types._base import MainResult, LegacyResult
from aperion.settings_loader import get_yaml_cfg
from aperion.plugins import Plugin, PluginInfo
...
if typing.TYPE_CHECKING:
    ...
    from aperion.plugins import PluginCfg
