...
from aperion.result_types import Result

if typing.TYPE_CHECKING:
    from aperion.search import SearchWithPlugins
    import flask

log: logging.Logger = logging.getLogger("aperion.plugins")
...
class Plugin(abc.ABC):
    ...
    def on_result(self, request: SXNG_Request, search: "SearchWithPlugins", result: Result) -> bool:
        ...
        .. hint::
           ...
           If :py:obj:`Result.url <aperion.result_types._base.Result.url>` is modified,
           :py:obj:`Result.parsed_url <aperion.result_types._base.Result.parsed_url>` must
    ...
    def post_search(self, request: SXNG_Request, search: "SearchWithPlugins") -> None | typing.Sequence[Result]:
        ...
        :py:obj:`Result <aperion.result_types._base.Result>` objects to be added to the
        final result list."""
        return
...
class PluginStorage:
    """A storage for managing the *plugins* of aperion."""
    ...
    def load_settings(self, cfg: dict[str, dict]):
        """Load plugins configured in aperion's settings :ref:`settings
        plugins`."""
    ...
    def post_search(self, request: SXNG_Request, search: "SearchWithPlugins") -> None:
        ...
        <aperion.results.ResultContainer`> with result items from plugins listed
        ...
        for plugin in [p for p in self.plugin_list if p.id in search.user_plugins]:
            ...
            # In case of *plugins* prefix ``plugin:`` is set, see aperion.result_types.Result
