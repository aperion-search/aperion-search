...
from aperion.data import TRACKER_PATTERNS
...
if typing.TYPE_CHECKING:
    ...
    from aperion.result_types import Result, LegacyResult
    from aperion.plugins import PluginCfg


log = logging.getLogger("aperion.plugins.tracker_url_remover")
